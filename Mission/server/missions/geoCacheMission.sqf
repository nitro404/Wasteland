...
diag_log format["WASTELAND SERVER - Geo Cache Mission Waiting to Run (%1)", _weaponCrateList];

[_missionDelay] call createWaitCondition;

diag_log format["WASTELAND SERVER - Geo Cache Mission Resumed (%1)", _weaponCrateList];
...
diag_log format["WASTELAND SERVER - Geo Cache Mission Waiting to Be Finished (%1)", _weaponCrateList];
...
diag_log format["WASTELAND SERVER - Geo Cache Mission Success (%1)", _weaponCrateList];
