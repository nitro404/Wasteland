...
private ["_randomPos","_plane","_cargoItem_1","_cargoItem_2","_cargoItem_3","_parachute","_dropPosition","_picture","_vehicleName","_missionType","_hint","_startTime","_currTime"];
